...
export const LABELS = {
  en: {
    ...
    removeMember: 'Remove',
    member_type_individual: 'Individual',
    member_type_company: 'Company',
    member_company_name: 'Company Name',
    member_company_ein: 'EIN',
    member_company_street: 'Company Street Address',
    member_company_city: 'Company City',
    member_company_state: 'Company State / Province',
    member_company_zip: 'Company ZIP',
    member_company_country: 'Company Country',
    member_rep_name: 'Representative Full Name',
    member_rep_email: 'Representative Email',
    member_rep_phone: 'Representative Phone',
    member_rep_address_street: 'Representative Street Address',
    member_rep_address_city: 'Representative City',
    member_rep_address_state: 'Representative State / Province',
    member_rep_address_zip: 'Representative ZIP',
    member_rep_address_country: 'Representative Country',
  ...
  it: {
    ...
    member_type_individual: 'Persona Fisica',
    member_type_company: 'Società',
    member_company_name: 'Nome Società',
    member_company_ein: 'EIN',
    member_company_street: 'Indirizzo Società',
    member_company_city: 'Città Società',
    member_company_state: 'Stato / Provincia Società',
    member_company_zip: 'CAP Società',
    member_company_country: 'Paese Società',
    member_rep_name: 'Nome Completo Rappresentante',
    member_rep_email: 'Email Rappresentante',
    member_rep_phone: 'Telefono Rappresentante',
    member_rep_address_street: 'Indirizzo Rappresentante',
    member_rep_address_city: 'Città Rappresentante',
    member_rep_address_state: 'Stato / Provincia Rappresentante',
    member_rep_address_zip: 'CAP Rappresentante',
    member_rep_address_country: 'Paese Rappresentante',
