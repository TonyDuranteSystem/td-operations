...
export const LABELS = {
  en: {
    ...
    priorYearReturn: 'Prior Year Tax Return (Form 1065)',
    priorYearReturnHint: 'Upload the previous year\'s filed tax return. This is needed for beginning balances on Schedule L.',
    priorYearReturnOptional: 'Upload if available',
  ...
  it: {
    ...
    priorYearReturn: 'Dichiarazione dei Redditi Anno Precedente (Form 1065)',
    priorYearReturnHint: 'Carica la dichiarazione dei redditi dell\'anno precedente. Necessaria per i saldi iniziali dello Schedule L.',
    priorYearReturnOptional: 'Carica se disponibile',
