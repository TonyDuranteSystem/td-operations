...
export const LABELS = {
  en: {
    ...
    ss4Upload: 'SS-4 Form',
    itinUpload: 'ITIN Letter (if you have one)',
    taxReturnPreviousUpload: 'Previous Year Tax Return (if filed)',
    taxReturnCurrentUpload: 'Current Year Tax Return (if filed)',
  ...
  it: {
    ...
    itinUpload: 'Lettera ITIN (se ne hai una)',
    taxReturnPreviousUpload: 'Dichiarazione dei redditi anno precedente (se presentata)',
    taxReturnCurrentUpload: 'Dichiarazione dei redditi anno corrente (se presentata)',
