...
/**
 * Shared staff conversations panel: a list of conversations on the left (with a
 * "new conversation" composer) and the realtime chat on the right. Fills its
 * parent (the parent owns page padding/height). Used by the CRM TD Communication
 * dashboard's Chat tab.
 */
export function StaffConversations({
  viewer,
