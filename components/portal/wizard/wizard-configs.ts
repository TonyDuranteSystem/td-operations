...
export const TAX_MMLLC_FIELDS: Record<string, FieldConfig[]> = {
  ...
  compliance: [
    ...
    { name: 'comp_digital_assets_detail', label: 'Tell us what happened with the digital assets', labelIt: 'Raccontaci cosa è successo con gli asset digitali', type: 'textarea', required: true, conditional: { field: 'comp_digital_assets', value: 'Yes' }, hint: 'Which exchange or wallet (Kraken, Coinbase, Binance…), and what happened: did you receive crypto as payment from customers? Sell or convert crypto to dollars/euros? Or only buy and hold? A short description is enough — we take it from there.', hintIt: 'Quale exchange o wallet (Kraken, Coinbase, Binance…), e cosa è successo: hai ricevuto crypto come pagamento dai clienti? Venduto o convertito crypto in dollari/euro? O solo comprato e tenuto? Basta una breve descrizione — al resto pensiamo noi.' },
    { name: 'comp_digital_assets_report', label: 'Yearly transaction report from the exchange (upload if you have it)', labelIt: 'Report annuale delle transazioni dall\'exchange (caricalo se ce l\'hai)', type: 'file', required: false, conditional: { field: 'comp_digital_assets', value: 'Yes' }, hint: 'Every exchange can export a yearly transaction report (Kraken and Coinbase even produce a tax form called 1099-DA). The bank statements do NOT show what happened on the exchange — without this report, crypto income and gains are invisible. If you can\'t find it now, we will request it from you later.', hintIt: 'Ogni exchange può esportare un report annuale delle transazioni (Kraken e Coinbase producono anche un modulo fiscale chiamato 1099-DA). Gli estratti conto bancari NON mostrano cosa è successo sull\'exchange — senza questo report, i ricavi e i guadagni in crypto sono invisibili. Se non lo trovi ora, te lo chiederemo più avanti.' },
