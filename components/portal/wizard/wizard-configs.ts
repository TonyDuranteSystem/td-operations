...
export const TAX_MMLLC_FIELDS: Record<string, FieldConfig[]> = {
  ...
  compliance: [
    ...
    { name: 'comp_digital_assets_detail', label: 'Tell us what happened with the digital assets', labelIt: 'Raccontaci cosa è successo con gli asset digitali', type: 'textarea', required: true, conditional: { field: 'comp_digital_assets', value: 'Yes' }, hint: 'Which exchange or wallet (Kraken, Coinbase, Binance…), and what happened: did you receive crypto as payment from customers, or sell/convert it to dollars or euros? A short description is enough — we take it from there.', hintIt: 'Quale exchange o wallet (Kraken, Coinbase, Binance…), e cosa è successo: hai ricevuto crypto come pagamento dai clienti, o venduto/convertito in dollari o euro? Basta una breve descrizione — al resto pensiamo noi.' },
    { name: 'comp_digital_assets_report', label: 'Tax form (1099 / 1099-DA) or yearly transaction report from the exchange (upload if you have it)', labelIt: 'Modulo fiscale (1099 / 1099-DA) o report annuale delle transazioni dall\'exchange (caricalo se ce l\'hai)', type: 'file', required: false, conditional: { field: 'comp_digital_assets', value: 'Yes' }, hint: 'If the exchange sent you a 1099 / 1099-DA, upload that — it is exactly what the accountant needs. Otherwise, every exchange can export a yearly transaction report. The bank statements do NOT show what happened on the exchange — without this, crypto income and gains are invisible. If you can\'t find it now, we will request it from you later.', hintIt: 'Se l\'exchange ti ha inviato un 1099 / 1099-DA, carica quello — è esattamente ciò che serve al commercialista. Altrimenti, ogni exchange può esportare un report annuale delle transazioni. Gli estratti conto bancari NON mostrano cosa è successo sull\'exchange — senza questo, i ricavi e i guadagni in crypto sono invisibili. Se non lo trovi ora, te lo chiederemo più avanti.' },
