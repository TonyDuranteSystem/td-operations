...
/**
 * Renders the contact request form (handles both add_new and update_existing modes).
 * Used both by the public route (/contact-request/...) and the portal route
 * (/portal/form/...). Token-authenticated; no Supabase session required.
 *
 * @param embedded — when true, drops the gray page background + outer wrapper
 *                   so the form sits cleanly inside the portal layout.
 */
export function ContactRequestForm({
  ...
  const card = embedded
    ...
    : 'max-w-2xl mx-auto bg-white rounded-lg shadow'
