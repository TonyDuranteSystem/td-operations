...
_Last verified against code: 2026-06-04 — Claude (Phase B: approval notification safety + CRM mirror — emitApprovalOutcome / runNotificationSweep / sendApprovalNotification; proposeAction fires a propose heads-up — see the Hermes-bridge sibling section)_
