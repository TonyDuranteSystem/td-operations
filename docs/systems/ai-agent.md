...
_Last verified against code: 2026-06-04 — Claude (Phase A: worker gains read-only codebase_read/codebase_search; proposeAction optional thread_id; new hermes-health staleness helper — see the Hermes-bridge sibling section)_
