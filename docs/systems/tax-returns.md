# Tax Returns & Filings
_Last verified against code: 2026-06-10 — Claude (Phase 2 complete: dropped india_status/sent_to_india/sent_to_india_date/india_follow_up_count columns + india_status enum from tax_returns; database.types.ts updated manually with accountant_* cols + review_status/review_history on tax_return_submissions; augmented type bridge removed; observability trigger + seed script updated to sent_to_accountant.)_
