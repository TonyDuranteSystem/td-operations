...
- **`translationLooksValid`** rejects an answer whose `{placeholder}` set differs from the source or whose length ratio is absurd (<0.1 or >8 for sources ≥30 chars). Keep it conservative, because a false rejection recreates a no-progress loop. Measured on 44 real wizard sentences (2026-09-23), all accepted: Japanese 0.26–0.80, Chinese 0.20–0.61, Arabic 0.71–1.38, Thai 0.68–1.63 of the English length.
