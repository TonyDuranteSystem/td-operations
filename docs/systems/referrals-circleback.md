...
_Last verified against code: 2026-06-03 — Claude (credit application reworked to click-to-apply: referral.ts no longer auto-reconciles; credit-netting.ts gains applyAvailableCreditToInvoice; reconcileAccountCredits retained but no longer auto-invoked)_
