...
_Last verified against code: 2026-06-04 — Claude (Phase A core scaffolding: threading/health/summary schema, read-only codebase tools in the worker, proposeAction thread_id, hermes-health cron — see "Phase A" section)_
