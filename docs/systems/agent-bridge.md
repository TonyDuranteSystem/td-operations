...
_Last verified against code: 2026-06-04 — Claude (direct-trigger URL fix: getInternalBaseUrl now uses VERCEL_PROJECT_PRODUCTION_URL, never the deployment-specific VERCEL_URL that 401'd self-calls and left rows pending; + cron-registration vs schedule note)_
