...
_Last verified against code: 2026-06-04 — Claude (Phase B safety + notifications: notification_sent retry sweep, CRM team-chat mirror, expiry callbacks set the flag, propose notification — see "Phase B" section)_
