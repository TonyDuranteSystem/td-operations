...
_Last verified against code: 2026-06-11 — Claude (bank_statement_pnl totals now come from the shared `computePnlTotals` in lib/pnl-generator (F1 signed refunds / F3 contribution category — see tax-returns.md); `bank_statement_recategorize` enum gains `contribution`.)_
