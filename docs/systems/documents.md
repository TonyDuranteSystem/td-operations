# Documents & Storage
_Last verified against code: 2026-07-02 — Claude (`lib/pdf/itin-data-summary.ts` deleted — dead code, zero callers; see "PDF generation" section note. No behavior change to any live document path.)_
