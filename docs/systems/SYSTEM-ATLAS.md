...
<!-- GENERATED:hooks -->
_Regenerated 2026-09-16. Files in `.claude/hooks/` (test harnesses excluded); "registered" = referenced by a command in `.claude/settings.json`._
...
<!-- GENERATED:surface -->
_Regenerated 2026-09-16 by directory scan._
...
<!-- GENERATED:rules -->
_Regenerated 2026-09-16 from the R-rule list in CLAUDE.md — **42 rules**, highest is R113._
...
- [formation.md](formation.md) — Company Formation _(verified 2026-09-11)_
