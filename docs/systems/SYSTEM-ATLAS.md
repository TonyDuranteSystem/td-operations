...
<!-- GENERATED:mcp-tools -->
_Regenerated 2026-09-09. Source of truth: uncommented `register*Tools(server)` in `app/api/[transport]/route.ts` (never a grep across tool files — an unregistered file is not active)._
...
<!-- GENERATED:hooks -->
_Regenerated 2026-09-09. Files in `.claude/hooks/` (test harnesses excluded); "registered" = referenced by a command in `.claude/settings.json`._
...
<!-- GENERATED:rules -->
_Regenerated 2026-09-09 from the R-rule list in CLAUDE.md — **42 rules**, highest is R113._
...
- **R070** — Run git pull origin main BEFORE any work, every session (enforced by SessionStart hook session-git-pull.sh). **Governs the PRIMARY CHECKOUT. …_(truncated — read the full rule in CLAUDE.md)_
...
<!-- GENERATED:deep-docs -->
_Regenerated 2026-09-09. Every subsystem doc under `docs/systems/` (42 docs), with the date each was last verified against code — **an old date means treat that doc as a hint and check the code**._
...
- [banking-bankfeed.md](banking-bankfeed.md) — Banking & Bank-Feed Reconciliation _(verified 2026-09-09)_
- [billing-invoicing.md](billing-invoicing.md) — Billing & Invoicing _(verified 2026-09-09)_
...
- [flows.md](flows.md) — Service Flow Workspaces _(verified 2026-09-08)_
...
- [portal-chats.md](portal-chats.md) — Portal Chats (staff composer) _(verified 2026-09-07)_
- [portal.md](portal.md) — Client Portal _(verified 2026-09-06)_
...
- [staff-notes.md](staff-notes.md) — Staff Sticky Notes (floating post-its) _(verified 2026-09-08)_
...
- [td-books.md](td-books.md) — TD Books (My Finances — the owner's company books) _(verified 2026-09-04)_
- [td-communication.md](td-communication.md) — TD Communication _(verified 2026-08-23)_
- [team-workspace.md](team-workspace.md) — Team Workspace (internal Slack-replacement chat) _(verified 2026-09-08)_
