# MCP Tool Server
_Last verified against code: 2026-06-05 — Claude (WP2: agent threads group += thread_create, and agent_msg_send gains an optional thread_id — see the Agent threads group bullet + agent-bridge.md WP2)_
