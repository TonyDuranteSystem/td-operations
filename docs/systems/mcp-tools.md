# MCP Tool Server
_Last verified against code: 2026-06-29 — Claude (doc note: `lib/mcp/instructions.ts` formation pipeline text updated from 7 → 8 stages: added "SS-4 Sent to IRS" between SS-4 Signed and EIN Received. No tool added/removed — instructions text only. See formation.md.)_
