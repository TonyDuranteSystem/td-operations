# MCP Tool Server
_Last verified against code: 2026-06-04 — Claude (approval_list gained an optional batch_id filter — Hermes bridge Phase D batch grouping)_
