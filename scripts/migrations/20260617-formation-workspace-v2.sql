...
VALUES
  ...
  ('Company Formation', 3, 'Filed with State',
   ...
   '{"description": "Name filed on the Secretary of State site. Waiting for the state to confirm (~1 week). When the Articles arrive, advance. If the name was rejected, choose a new name and refile.", "components": [{"type": "info_panel"}, {"type": "external_link", "label": "File on the Secretary of State site"}, {"type": "document_upload", "label": "Upload filing receipt", "autoAdvance": false}, {"type": "document_upload", "label": "Upload Articles of Organization", "autoAdvance": false}, {"type": "chat"}, {"type": "action_buttons", "actions": [{"key": "advance_next", "label": "Articles Received — Company Created", "target": "Articles Received"}, {"key": "advance_next", "label": "Name Rejected — Choose New Name", "target": "Filed with State"}]}]}'::jsonb),
