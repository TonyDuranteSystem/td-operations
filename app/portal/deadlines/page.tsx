...
export default async function PortalDeadlinesPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-semibold tracking-tight text-zinc-900">{t('deadlines.title', locale)}</h1>
        <p className="text-zinc-500 text-xs sm:text-sm mt-1">{t('deadlines.subtitle', locale)}</p>
      </div>
