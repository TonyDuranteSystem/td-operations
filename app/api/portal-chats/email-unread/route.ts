...
export async function GET() {
  ...
  try {
    // 1. Unread inbox threads in support@ (the shared client-facing mailbox)
    ...
    // 2. External addresses per unread thread (From + To, minus our own)
    ...
    const threadExternalEmails: Array<Set<string>> = []
