...
/** Public portfolio images render in an <img> — restrict to safe raster formats (no SVG: active content). */
const IMAGE_EXTS = new Set(['png', 'jpg', 'jpeg', 'webp', 'gif'])

/**
 * POST /api/td-communication/admin/portfolio/upload-url — short-lived signed
 * upload URL so the browser uploads a portfolio image DIRECTLY to the PUBLIC
 * `assets` bucket under portfolio/ (used for a manual before/after upload).
 * canEdit (staff + scoped partner).
 *
