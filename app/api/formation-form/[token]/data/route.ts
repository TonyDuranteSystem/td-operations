/**
 * GET   /api/formation-form/[token]/data?code=...&preview=td   — fetch the formation submission
 * PATCH /api/formation-form/[token]/data                       — track-open, or record the completed submission
...
export async function GET(req: NextRequest, { params }: Params) {
  ...
  const access = await verifyTokenAccess<FormationFormRow>(req, "formation_submissions", "*", token, code, preview)
  if (access.error) {
...
export async function PATCH(req: NextRequest, { params }: Params) {
  ...
  const access = await verifyTokenAccess<FormationFormRow>(
    req,
    "formation_submissions",
