...
/**
 * GET /api/cron/email-content-capture — every 10 min.
 *
 ...
 *
 * Gated on the same switch as the backfill (`email_content_backfill_enabled`),
 * so turning "Email backup" on captures both history AND all future mail.
 */
