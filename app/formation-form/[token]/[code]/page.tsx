...
export default function FormationFormCodePage() {
  ...
  const trackOpen = useCallback((sub: FormationSubmission) => {
  ...
  const loadSubmission = useCallback(async () => {
    try {
      ...
      const sub = resBody.data as FormationSubmission
  ...
  async function handleSubmit() {
    ...
    // For MMLLC, validate passports for individual members only (skip in admin preview mode)
  ...
  // Email verification gate (kept for completeness but will not show since verified=true when code matches)
