...
const LABELS = {
  en: {
    ...
    futureDevelopmentsIntro: 'As we move forward together, we can discuss next steps:',
  ...
  it: {
    ...
    futureDevelopmentsIntro: 'Procedendo insieme, possiamo ragionare su passi successivi:',
                  ...
                  <div key={i} className="offer-riepilogo-section">
                    ...
                    <div className="offer-riepilogo-total">
                      ...
                      <span style={i === 0 && dynamicTotal ? { transition: 'all 0.3s' } : undefined}>
                        {i === 0 && dynamicTotal ? dynamicTotal.servicesFormatted : r.total}
                      </span>
                    </div>
                  </div>
                ))}
